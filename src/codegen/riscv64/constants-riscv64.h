...
// RISCV constants
const uint32_t kBaseOpcodeShift = 0;
const uint32_t kBaseOpcodeBits = 7;
const uint32_t kFunct7Shift = 25;
const uint32_t kFunct7Bits = 7;
const uint32_t kFunct5Shift = 27;
const uint32_t kFunct5Bits = 5;
const uint32_t kFunct3Shift = 12;
const uint32_t kFunct3Bits = 3;
const uint32_t kFunct2Shift = 25;
const uint32_t kFunct2Bits = 2;
const uint32_t kRs1Shift = 15;
const uint32_t kRs1Bits = 5;
const uint32_t kRs2Shift = 20;
const uint32_t kRs2Bits = 5;
const uint32_t kRs3Shift = 27;
const uint32_t kRs3Bits = 5;
const uint32_t kRdShift = 7;
const uint32_t kRdBits = 5;
const uint32_t kRlShift = 25;
const uint32_t kAqShift = 26;
const uint32_t kImm12Shift = 20;
const uint32_t kImm12Bits = 12;
const uint32_t kShamtShift = 20;
const uint32_t kShamtBits = 5;
const uint32_t kShamtWShift = 20;
const uint32_t kShamtWBits = 6;
const uint32_t kArithShiftShift = 30;
const uint32_t kImm20Shift = 12;
const uint32_t kImm20Bits = 20;
const uint32_t kCsrShift = 20;
const uint32_t kCsrBits = 12;
const uint32_t kMemOrderBits = 4;
const uint32_t kPredOrderShift = 24;
const uint32_t kSuccOrderShift = 20;
